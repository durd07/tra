...
var (
	streams = make(map[tra.TraService_SubscribeServer]struct{})
)

// server is used to implement helloworld.GreeterServer.
type server struct {
	tra.UnimplementedTraServiceServer
}

// SayHello implements helloworld.GreeterServer
func (s *server) UpdateLskpmc(ctx context.Context, in *tra.LskpmcRequest) (int32, error) {
...
func (s *server) Subscribe(in *tra.LskpmcRequest, stream tra.TraService_SubscribeServer) error {
...
func grpcServer() {
	...
	tra.RegisterTraServiceServer(s, &myserver)
